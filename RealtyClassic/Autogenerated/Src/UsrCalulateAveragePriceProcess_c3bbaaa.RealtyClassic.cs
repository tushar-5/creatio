namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalulateAveragePriceProcess_c3bbaaaMethodsWrapper

	/// <exclude/>
	public class UsrCalulateAveragePriceProcess_c3bbaaaMethodsWrapper : ProcessModel
	{

		public UsrCalulateAveragePriceProcess_c3bbaaaMethodsWrapper(Process process)
			: base(process) {
